...
Logo.Position = UDim2.new(0.323, 0, 0.235, 0)
Logo.Size = UDim2.new(0.35, 0, 0.5, 0)
Logo.Image = "rbxassetid://116814662272690"
...
spawn(function()
    while wait(.1) do
		if Type == 1 then
			Pos = CFrame.new(0,20,-5)
		elseif Type == 2 then
			Pos = CFrame.new(5,20,0)
		elseif Type == 3 then
			Pos = CFrame.new(0,20,5)	
		elseif Type == 4 then
			Pos = CFrame.new(-5,20,0)
...
local PepsiUi = library:CreateWindow({
    Name = "Happy Hub PC Version Chicken",
        Background = {
            Asset = "rbxassetid://116814662272690"
        }
    })
...
local Farm_Lv = Main:CreateSection({
    Name = "|| Farm Level ||",
    Side = "Left"
})
        ...
        if _G.AutoFarm then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    ...
                    if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - NameMon.Position).Magnitude > 1500 then
                            BTP(NameMon)
                        else
                            topos(NameMon)
                        end
                            ...
                            if game.Workspace.Enemies:FindFirstChild(NameMon) then
                                for _, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                    if v.Name == NameMon then
                                        pcall(function()
                                            repeat task.wait()
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(15, 10, 2))
                                                EquipWeapon(_G.SelectWeapon)
                                                StartMagnet = true
                                ...
                                topos(NameMon * CFrame.new(15, 10, 2))
                                for _, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                    if v.Name == NameMon then
                                        repeat task.wait()
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(15, 10, 2))
                                ...
                                for _, y in pairs(game.ReplicatedStorage:GetChildren()) do
                                    if y.Name == Mon and y:FindFirstChild("HumanoidRootPart") then
                                        repeat task.wait()
                                            topos(y.HumanoidRootPart.CFrame * CFrame.new(15, 10, 2))
                                ...
                                for _, v in pairs(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()) do
                                    if string.find(v.Name, NameMon) then
                                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Position).Magnitude >= 10 then
                                            topos(v.CFrame * CFrame.new(15, 10, 2))
                                        end
                                        break
                                    end
                                end
...
local FightingStyle = Main:CreateSection({
    Name = "|| Fighting Style ||",
    Side = "Left"
})
...
local Chest = Main:CreateSection({
    Name = "|| Chest ||",
    Side = "Left"
})

Chest:AddToggle({
    Name = "Auto Farm Chest [Normal]​",
	Value = false,
    Callback = function(value)
        AutoFarmChest = value
    end
...
local Bone = Main:CreateSection({
    Name = "|| Bones ||",
    Side = "Left"
})

local ListB = {"NoQuest", "AcceptQuest", "MasteryFruit"}
local BoneFarm = Bone:AddToggle({
    Name = "Auto Farm Bone [No Quest]​",
	Value = false,
    Callback = function(value)
        _G.Auto_Bone = value
        BoneFMode = "NoQuest"
...
FS:AddToggle({
    ...
    Callback = function(value)
        _G.LockFPS = value
        setfpscap(_G.LockFPS and _G.SelectFPS or 900)
    end
})
...
spawn(function()
    while wait() do
        local blackScreenGui = game:GetService("Players").LocalPlayer.PlayerGui.Main.Blackscreen
        if _G.BlackScreen then
            blackScreenGui.Size = UDim2.new(500, 0, 500, 500)
            setfpscap(30)
        else
            blackScreenGui.Size = UDim2.new(1, 0, 500, 500)
            setfpscap(120)
        end
    end
end)
...
FS:AddToggle({
    ...
    Callback = function(value)
        ...
        local function optimize()
            local function setAllChildrenProperty(parent, property, value)
                for _, child in ipairs(parent:GetChildren()) do
                    if child:IsA("BasePart") and value then
                        child[property] = value
                    end
                    setAllChildrenProperty(child, property, value)
                end
            end
            setAllChildrenProperty(game:GetService("Workspace"), "Material", Enum.Material.SmoothPlastic)
            setAllChildrenProperty(game:GetService("Workspace"), "Reflectance", 0)
        end
        optimize()
    end
})
			...
			while task.wait() do
				pcall(function()
					...
					if not shared.cpc then shared.cpc = STOP.play end
						...
						if Hits then
            					if _G.FastAttack and _G.FastAttackTwo then
        ...
        if _G.BringMonster then
            pcall(function()
                ...
                for _, v in pairs(workspace.Enemies:GetChildren()) do
                    if (questVisible and v.Name == Mon) or (not questVisible) then
                ...
                for _, v in pairs(enemies) do
                    if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        ...
                        if distance <= 400 then
                            local canModify = syn and isnetworkowner(v.HumanoidRootPart) or not syn
                            if canModify then
                                v.HumanoidRootPart.CFrame = PosMon
                                v.Humanoid.WalkSpeed = 0
                                v.Humanoid.JumpPower = 0
            ...
            if _G.BringMonster then
                ...
                for _, enemy in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if humanoid and humanoidRootPart and humanoid.Health > 0 then
                        ...
                        if _G.AutoFarm and StartMagnet and enemy.Name == Mon and 
                           (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and distance <= 220 then
                        ...
                        elseif _G.AutoFarm and StartMagnet and enemy.Name == Mon and distance <= 350 then
        ...
        pcall(function()
            if _G.AutoFarmNearest and AutoFarmNearestMagnet and _G.BringMonster then
                for _, enemy in pairs(game.Workspace.Enemies:GetChildren()) do
                    if not string.find(enemy.Name, "Boss") and (enemy.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                        if InMyNetwork(enemy.HumanoidRootPart) then
                            ...
                            enemy.Head.CanCollide = false
                            enemy.Humanoid:ChangeState(11) -- Assuming 11 is a valid state for your use case
                            enemy.Humanoid:ChangeState(14) -- Assuming 14 is a valid state for your use case
                        end
                    end
                end
            end
...
local Stats = Main:CreateSection({
    Name = "|| Stats ||",
    Side = "Right"
})
...
Stats:AddToggle({
    ...
    Callback = function(t)
		...
		while MeleeState do
			task.wait()
			game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("AddPoint", "Melee", _G.Point)
		end
	end
})
...
Stats:AddToggle({
    ...
    Callback = function(t)
		...
		while DeState do
			task.wait()
			game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("AddPoint", "Defense", _G.Point)
		end
	end
})
...
Stats:AddToggle({
    ...
    Callback = function(t)
		...
		while SState do
			task.wait()
			game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("AddPoint", "Sword", _G.Point)
		end
	end
})
...
Stats:AddToggle({
    ...
    Callback = function(t)
		...
		while GState do
			task.wait()
			game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("AddPoint", "Gun", _G.Point)
		end
	end
})

Stats:AddToggle({
    Name = "Auto Up Stats Fruit",
	Value = false,
    Callback = function(t)
		DemonFruitState = t
		while DemonFruitState do
			task.wait()
			game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("AddPoint", "Demon Fruit", _G.Point)
		end
	end
})
...
local A = Shop:CreateSection({
    Name = "|| Abilities ||",
    Side = "Left"
})

A:AddButton({
    Name = "Geppo [ $10,000 Beli ]",
    Callback = function()
...
local F = Shop:CreateSection({
    Name = "|| Fighting Style ||",
    Side = "Left"
})

F:AddButton({
    Name = "Black Leg [ $150,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end
})
...
F:AddButton({
    Name = "Fishman Karate [ $750,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end
})
...
F:AddButton({
    Name = "Dragon Claw [ $1,500 Fragments ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end
...
F:AddButton({
    Name = "Super Human [ $3,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end
})
...
F:AddButton({
    Name = "Death Step [ $5,000 Fragments $5,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end
})
...
F:AddButton({
    Name = "Sharkman Karate [ $5,000 Fragments $2,500,000 Beli ]",
    Callback = function()
...
F:AddButton({
    Name = "Electric Claw [ $5,000 Fragments $3,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end
})
...
F:AddButton({
    Name = "Dragon Talon [ $5,000 Fragments $3,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end
})
...
F:AddButton({
    Name = "God Human [ $5,000 Fragments $5,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end
})

local B = Shop:CreateSection({
    Name = "|| Bones ||",
    Side = "Left"
})

B:AddButton({
    Name = "Surprise [ $50 Bone ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
    end
})
...
B:AddButton({
    Name = "Race Reroll [ $50 Bone ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,3)
    end
})

local St = Shop:CreateSection({
    Name = "|| Stats ||",
    Side = "Left"
})
                        ...
                        if v.Name == "Cake Queen" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    v.Humanoid.WalkSpeed = 0
                                    v.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                    topos(v.HumanoidRootPart.CFrame * Pos) -- Pos is not defined, please define it
                                    game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                    sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
